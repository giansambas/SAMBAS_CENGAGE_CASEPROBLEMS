        ...
        for (int i = 0; i < contestants.Length; i++)
        {
            ...
            do
            {
                ...
                if (categoryInput.Length == 1)
                {
                    ...
                    {
                        case 'C':
                            tempC = new ChildContestant();
                            break;
                        case 'T':
                            tempC = new TeenContestant();
                            break;
                        case 'A':
                            tempC = new AdultContestant();
                            break;
                    }
                }
...
class Contestant
{
    ...
    public override string ToString()
    {
        return string.Format("{0} {1} {2} Fee {3}",
            GetType().Name.Replace("Contestant", ""),
            Name,
            TalentCode,
...
class ChildContestant : Contestant
{
    ...
    public override string ToString()
    {
        return string.Format("Child Contestant {0} {1} Fee {2}",
            this.Name,
            this.TalentCode,
            this.Fee.ToString("C", CultureInfo.GetCultureInfo("en-US"))
        );
    }
}
...
class TeenContestant : Contestant
{
    ...
    public override string ToString()
    {
        return string.Format("Teen Contestant {0} {1} Fee {2}",
            this.Name,
            this.TalentCode,
            this.Fee.ToString("C", CultureInfo.GetCultureInfo("en-US"))
        );
...
class AdultContestant : Contestant
{
    ...
    public override string ToString()
    {
        return string.Format("Adult Contestant {0} {1} Fee {2}",
            this.Name,
            this.TalentCode,
            this.Fee.ToString("C", CultureInfo.GetCultureInfo("en-US"))
        );
